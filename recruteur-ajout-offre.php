<?php include "view/header-recru-nav.view.php";?>
    ...
    <h1 class="container text-center">Mes offres</h1>

    <!-- OFFRES a rajouter au fur et à mesure -->

    <section>
        <p class="paragraphe">Vous avez deux offres</p>
        <div class="offre">
    ...
    <h2 class="container text-center">Ajouter une offre</h2>
