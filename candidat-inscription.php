<?php
include "view/header-cand-logo.view.php";
?>
        ...
        <div class="container">
            <div class="row justify-content-around">
                ...
                <form class="col-md-4">
                    ...
                    <div class="form-group">
                        <label class="form-control-sm">Votre CV doit être strictement anonyme et être écrit au masculin et au format PDF</label>
    ...
    <div class="form-row text-center">
        <div class="col-12">
            <button type="submit" class="btn col-one ">Enregistrer</button>
        </div>
    </div>
