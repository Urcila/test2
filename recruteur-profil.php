...
<?php include "view/header-recru-nav.view.php";?>
    ...
    <!-- DEBUT SECTION -->
                ...
                <div class="row justify-content-around">
                    <form class="col-md-4">
                        ...
                        <div class="form-group">
                                ...
                                <input type="password" class="form-control modif-info" value="******" disabled>
                                <button type="submit"id="apparait" class="btn col-reverse">Modifier</button>
                        </div>
                        ...
                        <div class="newmdp form-group">
                            <input type="text" id="newmdp" placeholder="nouveau mot de passe"> 
                            <button type="submit"id="apparait" class="btn col-reverse">Modifier</button>
                        </div>-->
                    </form>
                    ...
                    <form class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="entreprise" disabled>
                        </div>
                        <div class="form-group">
                            <label for="exampleFormControlSelect1">Siret</label>
                            <input type="text" class="form-control" value="siret" disabled >
                        </div>
                    </form>
                </div>
            </div>
        ...
        <h2 class="container text-center">Mes offres</h2>
        <section>
            <div id="offres" class="text-center">
                <input type="text" id="offre">
                <button type="submit"id="modifieroffres" class="btn col-reverse">Modifier</button>
            </div>
        </section>
